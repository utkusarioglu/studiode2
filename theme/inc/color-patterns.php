 ...
 */
function studiode2_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'studiode2_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.studiode2-front-page) .entry-title,
...
.colors-custom .studiode2-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.studiode2-front-page .panel-content .recent-posts article,
...
.colors-custom.studiode2-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'studiode2_custom_colors_css', $css, $hue, $saturation );
}
